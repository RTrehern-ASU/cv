...
```{r}
if(PDF_EXPORT){
  cat("View this CV online with links at github.com/RTrehern-ASU/cv")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this Resume](https://github.com/RTrehern-ASU/cv/blob/main/Trehern_Resume.pdf)")
}
```
